 ...
 */
class Version20151014141107 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE User DROP section, DROP code_section, DROP galaxy_picture, DROP birthdate, DROP gender, DROP mobile');
    }
}
